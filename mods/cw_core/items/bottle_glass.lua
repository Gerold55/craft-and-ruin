...
-- Item
core.register_craftitem("cw_core:bottle_glass", {
...
if core.registered_items["default:glass"] then
  add_bottle_recipe("default:glass")
end
if core.registered_items["cw_core:glass"] then
...
-- core.register_craft({ type="shapeless", output="cw_core:bottle_glass",
